...
///The following makes the following functions have 'C' linkages and corresponds to the MainWindow.xaml.cs C# functions
extern "C" {
...
///The following initiates the CCube class (used to create the 3D Cube!) 
class CCube
{
